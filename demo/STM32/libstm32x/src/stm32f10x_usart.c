...
* Description    : Deinitializes the CONSOLE_UART peripheral registers to their
*                  default reset values.
* Input          : - CONSOLE_UART: where x can be 1, 2 or 3 to select the USART
*                    peripheral.
* Output         : None
* Return         : None
*******************************************************************************/
void USART_DeInit(USART_TypeDef* CONSOLE_UART)
{
  switch (*(u32*)&CONSOLE_UART)
  {
    case USART1_BASE:
...
* Description    : Initializes the CONSOLE_UART peripheral according to the specified
*                  parameters in the USART_InitStruct .
* Input          : - CONSOLE_UART: where x can be 1, 2 or 3 to select the USART peripheral.
...
* Return         : None
*******************************************************************************/
void USART_Init(USART_TypeDef* CONSOLE_UART, USART_InitTypeDef* USART_InitStruct)
{
...
/*---------------------------- USART CR2 Configuration -----------------------*/
  ...
  /* Write to USART CR2 */
  CONSOLE_UART->CR2 = (u16)tmpreg;

/*---------------------------- USART CR1 Configuration -----------------------*/
  tmpreg = 0x00;
  tmpreg = CONSOLE_UART->CR1;
  ...
  /* Write to USART CR1 */
  CONSOLE_UART->CR1 = (u16)tmpreg;

/*---------------------------- USART CR3 Configuration -----------------------*/
  tmpreg = 0x00;
  tmpreg = CONSOLE_UART->CR3;
...
/*---------------------------- USART BRR Configuration -----------------------*/
  ...
  if ((*(u32*)&CONSOLE_UART) == USART1_BASE)
  {
...
* Input          : - CONSOLE_UART: where x can be 1, 2 or 3 to select the USART
*                    peripheral.
*                : - NewState: new state of the CONSOLE_UART peripheral.
*                    This parameter can be: ENABLE or DISABLE.
* Output         : None
* Return         : None
*******************************************************************************/
void USART_Cmd(USART_TypeDef* CONSOLE_UART, FunctionalState NewState)
{
  /* Check the parameters */
...
*                       - USART_IT_CTS
*                       - USART_IT_ERR
*                  - NewState: new state of the specified CONSOLE_UART interrupts.
*                    This parameter can be: ENABLE or DISABLE.
* Output         : None
* Return         : None
*******************************************************************************/
void USART_ITConfig(USART_TypeDef* CONSOLE_UART, u16 USART_IT, FunctionalState NewState)
{
...
* Return         : None
*******************************************************************************/
void USART_DMACmd(USART_TypeDef* CONSOLE_UART, u16 USART_DMAReq, FunctionalState NewState)
{
  /* Check the parameters */
  ...
  if (NewState != DISABLE)
  {
    ...
    CONSOLE_UART->CR3 |= USART_DMAReq;
  }
  else
  {
    /* Disable the DMA transfer for selected requests by clearing the DMAT and/or
    DMAR bits in the USART CR3 register */
    CONSOLE_UART->CR3 &= (u16)~USART_DMAReq;
  }
}
...
* Return         : None
*******************************************************************************/
void USART_SetAddress(USART_TypeDef* CONSOLE_UART, u8 USART_Address)
{
  /* Check the parameters */
  assert_param(IS_USART_ADDRESS(USART_Address)); 
    
  /* Clear the USART address */
  CONSOLE_UART->CR2 &= CR2_Address_Mask;
  /* Set the USART address node */
  CONSOLE_UART->CR2 |= USART_Address;
}
...
* Return         : None
*******************************************************************************/
void USART_WakeUpConfig(USART_TypeDef* CONSOLE_UART, u16 USART_WakeUp)
{
  /* Check the parameters */
  assert_param(IS_USART_WAKEUP(USART_WakeUp));
  
  CONSOLE_UART->CR1 &= CR3_WAKE_Mask;
  CONSOLE_UART->CR1 |= USART_WakeUp;
}
...
* Return         : None
*******************************************************************************/
void USART_ReceiverWakeUpCmd(USART_TypeDef* CONSOLE_UART, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState)); 
...
* Return         : None
*******************************************************************************/
void USART_LINBreakDetectLengthConfig(USART_TypeDef* CONSOLE_UART, u16 USART_LINBreakDetectLength)
{
  /* Check the parameters */
  assert_param(IS_USART_LIN_BREAK_DETECT_LENGTH(USART_LINBreakDetectLength));
  
  CONSOLE_UART->CR2 &= CR3_LBDL_Mask;
  CONSOLE_UART->CR2 |= USART_LINBreakDetectLength;  
}
...
* Return         : None
*******************************************************************************/
void USART_LINCmd(USART_TypeDef* CONSOLE_UART, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  if (NewState != DISABLE)
  {
    ...
    CONSOLE_UART->CR2 |= CR2_LINE_Set;
  }
  else
  {
    /* Disable the LIN mode by clearing the LINE bit in the CR2 register */
    CONSOLE_UART->CR2 &= CR2_LINE_Reset;
  }
}

/*******************************************************************************
* Function Name  : USART_SendData
* Description    : Transmits signle data through the CONSOLE_UART peripheral.
* Input          : - CONSOLE_UART: where x can be 1, 2 or 3 to select the USART
*                    peripheral.
...
* Return         : None
*******************************************************************************/
void USART_SendData(USART_TypeDef* CONSOLE_UART, u16 Data)
{
  /* Check the parameters */
  assert_param(IS_USART_DATA(Data)); 
    
  /* Transmit Data */
  CONSOLE_UART->DR = (Data & (u16)0x01FF);
}

/*******************************************************************************
* Function Name  : USART_ReceiveData
* Description    : Returns the most recent received data by the CONSOLE_UART peripheral.
* Input          : - CONSOLE_UART: where x can be 1, 2 or 3 to select the USART
*                    peripheral.
* Output         : None
* Return         : The received data.
*******************************************************************************/
u16 USART_ReceiveData(USART_TypeDef* CONSOLE_UART)
{
  /* Receive Data */
  return (u16)(CONSOLE_UART->DR & (u16)0x01FF);
}
...
* Return         : None
*******************************************************************************/
void USART_SendBreak(USART_TypeDef* CONSOLE_UART)
{
  /* Send break characters */
  CONSOLE_UART->CR1 |= CR1_SBK_Set;
}
...
* Return         : None
*******************************************************************************/
void USART_SetGuardTime(USART_TypeDef* CONSOLE_UART, u8 USART_GuardTime)
{    
  /* Clear the USART Guard time */
  CONSOLE_UART->GTPR &= GTPR_LSB_Mask;
  /* Set the USART guard time */
  CONSOLE_UART->GTPR |= (u16)((u16)USART_GuardTime << 0x08);
}
...
* Return         : None
*******************************************************************************/
void USART_SetPrescaler(USART_TypeDef* CONSOLE_UART, u8 USART_Prescaler)
{ 
  /* Clear the USART prescaler */
  CONSOLE_UART->GTPR &= GTPR_MSB_Mask;
  /* Set the USART prescaler */
  CONSOLE_UART->GTPR |= USART_Prescaler;
}
...
* Return         : None
*******************************************************************************/
void USART_SmartCardCmd(USART_TypeDef* CONSOLE_UART, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  if (NewState != DISABLE)
  {
    ...
    CONSOLE_UART->CR3 |= CR3_SCEN_Set;
  }
  else
  {
    /* Disable the SC mode by clearing the SCEN bit in the CR3 register */
    CONSOLE_UART->CR3 &= CR3_SCEN_Reset;
  }
}
...
* Return         : None
*******************************************************************************/
void USART_SmartCardNACKCmd(USART_TypeDef* CONSOLE_UART, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  if (NewState != DISABLE)
  {
    ...
    CONSOLE_UART->CR3 |= CR3_NACK_Set;
  }
  else
  {
    /* Disable the NACK transmission by clearing the NACK bit in the CR3 register */
    CONSOLE_UART->CR3 &= CR3_NACK_Reset;
  }
...
* Return         : None
*******************************************************************************/
void USART_HalfDuplexCmd(USART_TypeDef* CONSOLE_UART, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  if (NewState != DISABLE)
  {
    ...
    CONSOLE_UART->CR3 |= CR3_HDSEL_Set;
  }
  else
  {
    /* Disable the Half-Duplex mode by clearing the HDSEL bit in the CR3 register */
    CONSOLE_UART->CR3 &= CR3_HDSEL_Reset;
  }
}
...
* Return         : None
*******************************************************************************/
void USART_IrDAConfig(USART_TypeDef* CONSOLE_UART, u16 USART_IrDAMode)
{
  /* Check the parameters */
  assert_param(IS_USART_IRDA_MODE(USART_IrDAMode));
    
  CONSOLE_UART->CR3 &= CR3_IRLP_Mask;
  CONSOLE_UART->CR3 |= USART_IrDAMode;
}
...
* Return         : None
*******************************************************************************/
void USART_IrDACmd(USART_TypeDef* CONSOLE_UART, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  if (NewState != DISABLE)
  {
    ...
    CONSOLE_UART->CR3 |= CR3_IREN_Set;
  }
  else
  {
    /* Disable the IrDA mode by clearing the IREN bit in the CR3 register */
    CONSOLE_UART->CR3 &= CR3_IREN_Reset;
  }
}
...
*******************************************************************************/
FlagStatus USART_GetFlagStatus(USART_TypeDef* CONSOLE_UART, u16 USART_FLAG)
{
  ...
  if ((CONSOLE_UART->SR & USART_FLAG) != (u16)RESET)
  {
    bitstatus = SET;
  }
  else
...
* Description    : Clears the CONSOLE_UART's pending flags.
* Input          : - CONSOLE_UART: where x can be 1, 2 or 3 to select the USART
*                    peripheral.
...
* Return         : None
*******************************************************************************/
void USART_ClearFlag(USART_TypeDef* CONSOLE_UART, u16 USART_FLAG)
{
  /* Check the parameters */
  assert_param(IS_USART_CLEAR_FLAG(USART_FLAG));
   
  CONSOLE_UART->SR &= (u16)~USART_FLAG;
}
...
*******************************************************************************/
ITStatus USART_GetITStatus(USART_TypeDef* CONSOLE_UART, u16 USART_IT)
{
  ...
  if (usartreg == 0x01) /* The IT  is in CR1 register */
  {
    itmask &= CONSOLE_UART->CR1;
  }
  else if (usartreg == 0x02) /* The IT  is in CR2 register */
  {
    itmask &= CONSOLE_UART->CR2;
  }
  else /* The IT  is in CR3 register */
  {
    itmask &= CONSOLE_UART->CR3;
  }
  
  bitpos = USART_IT >> 0x08;

  bitpos = (u32)0x01 << bitpos;
  bitpos &= CONSOLE_UART->SR;
...
* Description    : Clears the CONSOLE_UART�s interrupt pending bits.
* Input          : - CONSOLE_UART: where x can be 1, 2 or 3 to select the USART
*                    peripheral.
...
* Return         : None
*******************************************************************************/
void USART_ClearITPendingBit(USART_TypeDef* CONSOLE_UART, u16 USART_IT)
{
